const translations = {
  ...
  "Windows 95 Launch": "[start me up](https://tinyurl.com/y2c357p7)",
  "microsoft": "The company that convinced the world we need [17 different ways](https://youtu.be/8To-6VIJZRE) to collaborate badly.",
  ...
  "rick roll": "The internet's most beloved [surprise](https://www.youtube.com/watch?v=dQw4w9WgXcQ).",
  "zoom fatigue": "Death by a thousand '[Can you hear me now?](https://youtu.be/YQq2StSwg_s)' moments.",
  "dial-up internet": "The sound of [technological patience](https://youtu.be/gsNaR6FRuO0).",
  "windows startup": "The [triumphant sound](https://youtu.be/7nQ2oiVqKHw) of 'please don't crash today'.",
  "nokia ringtone": "The [anthem](https://youtu.be/uub9BhLA8rU) that defined a generation of pocket computers.",
  ...
  "kpi": "Numbers we track but don't understand.",
  ...
  "retro": "Group therapy for project trauma.",
  ...
  "waterfall": "The methodology where you discover what you actually needed after it's too late to change anything.",
  "gantt chart": "A beautiful lie about when things will actually get done.",
  "critical path": "The route through your project where everything will definitely go wrong.",
  "scope creep": "When 'just one small change' becomes a complete rewrite of reality.",
  "stakeholder": "Anyone who has opinions about your project but no accountability for its success.",
  "deliverable": "The thing you'll be explaining why it's late in next week's meeting.",
  "milestone": "A checkpoint where you realize you're behind schedule.",
  "risk register": "Your crystal ball for documenting everything that will inevitably happen anyway.",
  "lessons learned": "The document everyone writes but nobody reads for the next project.",
  "change request": "Formal paperwork for 'oops, we should have thought of this earlier.'",
  "retrospective": "Group therapy disguised as process improvement.",
  "ceo apology": "A carefully crafted [non-apology](https://youtu.be/15HTd4Um1m4) that somehow makes everything worse.",
  "this is fine": "The official motto of every [burning tech company](https://youtu.be/0oBx7Jg4m-o) circa 2023-2024.",
  "trump": "The ultimate beta test that somehow made it to production.",
};
